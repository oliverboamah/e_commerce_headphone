  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          Image.asset(earphoneData.image, width: 70, height: 70,),
          Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: <Widget>[
              Text(earphoneData.title, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),),
              Padding(
                padding: const EdgeInsets.only(top: 5.0),
                child: Text(earphoneData.price, style: TextStyle(color: Colors.grey),),
              )
            ],
          )
        ],
